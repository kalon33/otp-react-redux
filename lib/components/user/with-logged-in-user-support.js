...
class UserLoaderScreen extends Component {
  static displayName = 'UserLoaderScreen'
  ...
  render() {
    ...
    if (!WrappedComponent) {
      console.error('WrappedComponent is undefined in UserLoaderScreen')
      return null
    }
...
const UserLoaderScreenWithAuth0 = withAuth0(
...
UserLoaderScreenWithAuth0.displayName = 'UserLoaderScreenWithAuth0'
