...
export default function noLongerPossibleRenderer(monitoredTrip) {
  ...
  data.headingText = (
    <FormattedMessage id="components.TripStatusRenderers.noLongerPossible.heading" />
  )
  data.bodyText = (
    <FormattedMessage id="components.TripStatusRenderers.noLongerPossible.description" />
  )
