...
export default function notYetCalculatedTripRenderer(monitoredTrip) {
  ...
  data.headingText = (
    <FormattedMessage id="components.TripStatusRenderers.notCalculated.heading" />
  )
  data.lastCheckedText = (
    <FormattedMessage id="components.TripStatusRenderers.notCalculated.awaiting" />
  )
  data.bodyText = (
    <FormattedMessage id="components.TripStatusRenderers.notCalculated.description" />
  )
