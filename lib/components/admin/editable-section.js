...
import React, {Component as ComponentClass} from 'react'
 ...
 */
export default class EditableSection extends ComponentClass {
  state = {
    isEditing: false
  }
 ...
 */
class InputToggle extends ComponentClass {
  render () {
