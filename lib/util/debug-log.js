...
import { createEntryIdMinter, measureEntry } from './debug-log-entry'
...
// Per-entry ids are scoped to this app start; the session id supplies their
// collision resistance across devices and runs.
const mintEntryId = createEntryIdMinter(sessionId)
