...
// Saved places managed on-device (no account/login), unlike PLACES_PATH above.
export const LOCAL_PLACES_PATH = '/places'
// The rider's own settings (routing levers, turn-by-turn), kept on-device like
// LOCAL_PLACES_PATH above. Distinct from ACCOUNT_SETTINGS_PATH, which is the
// logged-in otp-middleware account screen this deployment does not use.
export const SETTINGS_PATH = '/settings'
// The in-app "Share feedback" screen: a comment and a screenshot, into the same
// ride-note sink the /ride console writes to. On-device like the two above.
