  ...
  if (args.length >= 1 && typeof args[0] === 'string') {
    ...
    if (
      ...
      (message.includes('ModeSelector3') ||
        message.includes('AdvancedModeSubsettingsContainer') ||
    ...
    // Suppress componentWillReceiveProps deprecation warnings from external components
    if (
      message.includes('componentWillReceiveProps has been renamed') &&
      message.includes('Overlay3')
    ) {
      return
    }
  }
